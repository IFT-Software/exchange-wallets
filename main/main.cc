...
int main(int argc, char **argv)
{
  ...
  uint8_t seed[] = {0x24, 0xd5, 0xe9, 0xfe, 0xbf, 0x08, 0xa9, 0x1d,
  ...
  std::cout << "Seed: " << Util::BytesToHex(seed, 64) << std::endl;
  ...
  std::cout << "privkey: " << Util::BytesToHex(bip32->GeneratePrivKey(seed), 32) << std::endl;
