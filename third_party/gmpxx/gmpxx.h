...
inline unsigned long __gmpxx_abs_ui(signed long l) {
  return l >= 0 ? static_cast<unsigned long>(l) : -static_cast<unsigned long>(l);
}
...
struct __gmp_binary_plus {
  ...
  static void eval(mpz_ptr z, unsigned long int l, mpz_srcptr w) { eval(z, w, l); }
  ...
  static void eval(mpz_ptr z, signed long int l, mpz_srcptr w) { eval(z, w, l); }
  ...
  static void eval(mpq_ptr q, unsigned long int l, mpq_srcptr r) { eval(q, r, l); }
  static inline void eval(mpq_ptr q, mpq_srcptr r, signed long int l);
  // defined after __gmp_binary_minus
  static void eval(mpq_ptr q, signed long int l, mpq_srcptr r) { eval(q, r, l); }
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, unsigned long int l) { mpf_add_ui(f, g, l); }
  static void eval(mpf_ptr f, unsigned long int l, mpf_srcptr g) { mpf_add_ui(f, g, l); }
  ...
  static void eval(mpf_ptr f, signed long int l, mpf_srcptr g) { eval(f, g, l); }
...
struct __gmp_binary_minus {
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, unsigned long int l) { mpf_sub_ui(f, g, l); }
  static void eval(mpf_ptr f, unsigned long int l, mpf_srcptr g) { mpf_ui_sub(f, l, g); }
  static void eval(mpf_ptr f, mpf_srcptr g, signed long int l) {
    if (l >= 0)
      mpf_sub_ui(f, g, l);
    else
...
inline void __gmp_binary_plus::eval(mpq_ptr q, mpq_srcptr r, signed long int l) {
  if (l >= 0)
    eval(q, r, static_cast<unsigned long>(l));
  else
...
struct __gmp_binary_lshift {
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, mp_bitcnt_t l) { mpf_mul_2exp(f, g, l); }
};
...
struct __gmp_binary_rshift {
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, mp_bitcnt_t l) { mpf_div_2exp(f, g, l); }
};
...
// gcc-3.3 doesn't have __builtin_ctzl. Don't bother optimizing for old gcc.
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, unsigned long int l) { mpf_mul_ui(f, g, l); }
  static void eval(mpf_ptr f, unsigned long int l, mpf_srcptr g) { mpf_mul_ui(f, g, l); }
  static void eval(mpf_ptr f, mpf_srcptr g, signed long int l) {
    if (l >= 0)
      mpf_mul_ui(f, g, l);
    else {
...
struct __gmp_binary_divides {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_tdiv_q(z, w, v); }
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, unsigned long int l) { mpf_div_ui(f, g, l); }
  static void eval(mpf_ptr f, unsigned long int l, mpf_srcptr g) { mpf_ui_div(f, l, g); }
  static void eval(mpf_ptr f, mpf_srcptr g, signed long int l) {
    if (l >= 0)
      mpf_div_ui(f, g, l);
    else {
...
struct __gmp_binary_modulus {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_tdiv_r(z, w, v); }

  static void eval(mpz_ptr z, mpz_srcptr w, unsigned long int l) { mpz_tdiv_r_ui(z, w, l); }
  static void eval(mpz_ptr z, unsigned long int l, mpz_srcptr w) {
    if (mpz_sgn(w) >= 0) {
      if (mpz_fits_ulong_p(w))
        mpz_set_ui(z, l % mpz_get_ui(w));
...
struct __gmp_cmp_function {
  ...
  static int eval(mpz_srcptr z, unsigned long int l) { return mpz_cmp_ui(z, l); }
  static int eval(unsigned long int l, mpz_srcptr z) { return -mpz_cmp_ui(z, l); }
  static int eval(mpz_srcptr z, signed long int l) { return mpz_cmp_si(z, l); }
  static int eval(signed long int l, mpz_srcptr z) { return -mpz_cmp_si(z, l); }
  ...
  static int eval(mpq_srcptr q, unsigned long int l) { return mpq_cmp_ui(q, l, 1); }
  static int eval(unsigned long int l, mpq_srcptr q) { return -mpq_cmp_ui(q, l, 1); }
  static int eval(mpq_srcptr q, signed long int l) { return mpq_cmp_si(q, l, 1); }
  static int eval(signed long int l, mpq_srcptr q) { return -mpq_cmp_si(q, l, 1); }
  static int eval(mpq_srcptr q, double d) {
    __GMPXX_TMPQ_D;
    return mpq_cmp(q, temp);
  }
  static int eval(double d, mpq_srcptr q) {
    __GMPXX_TMPQ_D;
    return mpq_cmp(temp, q);
  }
  static int eval(mpq_srcptr q, mpz_srcptr z) { return mpq_cmp_z(q, z); }
  static int eval(mpz_srcptr z, mpq_srcptr q) { return -mpq_cmp_z(q, z); }

  static int eval(mpf_srcptr f, mpf_srcptr g) { return mpf_cmp(f, g); }

  static int eval(mpf_srcptr f, unsigned long int l) { return mpf_cmp_ui(f, l); }
  static int eval(unsigned long int l, mpf_srcptr f) { return -mpf_cmp_ui(f, l); }
  static int eval(mpf_srcptr f, signed long int l) { return mpf_cmp_si(f, l); }
  static int eval(signed long int l, mpf_srcptr f) { return -mpf_cmp_si(f, l); }
  static int eval(mpf_srcptr f, double d) { return mpf_cmp_d(f, d); }
  static int eval(double d, mpf_srcptr f) { return -mpf_cmp_d(f, d); }
  static int eval(mpf_srcptr f, mpz_srcptr z) { return mpf_cmp_z(f, z); }
  static int eval(mpz_srcptr z, mpf_srcptr f) { return -mpf_cmp_z(f, z); }
  ...
  static int eval(mpq_srcptr q, mpf_srcptr f) { return -eval(f, q); }
};

struct __gmp_binary_equal {
  static bool eval(mpz_srcptr z, mpz_srcptr w) { return mpz_cmp(z, w) == 0; }

  static bool eval(mpz_srcptr z, unsigned long int l) { return mpz_cmp_ui(z, l) == 0; }
  static bool eval(unsigned long int l, mpz_srcptr z) { return eval(z, l); }
  static bool eval(mpz_srcptr z, signed long int l) { return mpz_cmp_si(z, l) == 0; }
  static bool eval(signed long int l, mpz_srcptr z) { return eval(z, l); }
  static bool eval(mpz_srcptr z, double d) { return mpz_cmp_d(z, d) == 0; }
  static bool eval(double d, mpz_srcptr z) { return eval(z, d); }

  static bool eval(mpq_srcptr q, mpq_srcptr r) { return mpq_equal(q, r) != 0; }

  static bool eval(mpq_srcptr q, unsigned long int l) {
    return ((__GMPXX_CONSTANT(l) && l == 0) || mpz_cmp_ui(mpq_denref(q), 1) == 0) &&
           mpz_cmp_ui(mpq_numref(q), l) == 0;
  }
  static bool eval(unsigned long int l, mpq_srcptr q) { return eval(q, l); }
  static bool eval(mpq_srcptr q, signed long int l) {
    return ((__GMPXX_CONSTANT(l) && l == 0) || mpz_cmp_ui(mpq_denref(q), 1) == 0) &&
           mpz_cmp_si(mpq_numref(q), l) == 0;
  }
  static bool eval(signed long int l, mpq_srcptr q) { return eval(q, l); }
  static bool eval(mpq_srcptr q, double d) {
    __GMPXX_TMPQ_D;
    return mpq_equal(q, temp) != 0;
  }
  ...
  static bool eval(mpz_srcptr z, mpq_srcptr q) { return eval(q, z); }

  static bool eval(mpf_srcptr f, mpf_srcptr g) { return mpf_cmp(f, g) == 0; }

  static bool eval(mpf_srcptr f, unsigned long int l) { return mpf_cmp_ui(f, l) == 0; }
  static bool eval(unsigned long int l, mpf_srcptr f) { return eval(f, l); }
  static bool eval(mpf_srcptr f, signed long int l) { return mpf_cmp_si(f, l) == 0; }
  static bool eval(signed long int l, mpf_srcptr f) { return eval(f, l); }
  static bool eval(mpf_srcptr f, double d) { return mpf_cmp_d(f, d) == 0; }
  static bool eval(double d, mpf_srcptr f) { return eval(f, d); }
  static bool eval(mpf_srcptr f, mpz_srcptr z) { return mpf_cmp_z(f, z) == 0; }
  static bool eval(mpz_srcptr z, mpf_srcptr f) { return eval(f, z); }
  static bool eval(mpf_srcptr f, mpq_srcptr q) { return __gmp_cmp_function::eval(f, q) == 0; }
  static bool eval(mpq_srcptr q, mpf_srcptr f) { return eval(f, q); }
};
...
struct __gmp_binary_less {
  ...
  static bool eval(mpz_srcptr z, unsigned long int l) { return mpz_cmp_ui(z, l) < 0; }
  static bool eval(unsigned long int l, mpz_srcptr z) { return mpz_cmp_ui(z, l) > 0; }
  static bool eval(mpz_srcptr z, signed long int l) { return mpz_cmp_si(z, l) < 0; }
  static bool eval(signed long int l, mpz_srcptr z) { return mpz_cmp_si(z, l) > 0; }
  static bool eval(mpz_srcptr z, double d) { return mpz_cmp_d(z, d) < 0; }
  ...
  static bool eval(mpq_srcptr q, unsigned long int l) { return mpq_cmp_ui(q, l, 1) < 0; }
  static bool eval(unsigned long int l, mpq_srcptr q) { return mpq_cmp_ui(q, l, 1) > 0; }
  static bool eval(mpq_srcptr q, signed long int l) { return mpq_cmp_si(q, l, 1) < 0; }
  static bool eval(signed long int l, mpq_srcptr q) { return mpq_cmp_si(q, l, 1) > 0; }
  static bool eval(mpq_srcptr q, double d) {
    __GMPXX_TMPQ_D;
    return mpq_cmp(q, temp) < 0;
  }
  static bool eval(double d, mpq_srcptr q) {
    __GMPXX_TMPQ_D;
    return mpq_cmp(temp, q) < 0;
  }
  static bool eval(mpq_srcptr q, mpz_srcptr z) { return mpq_cmp_z(q, z) < 0; }
  static bool eval(mpz_srcptr z, mpq_srcptr q) { return mpq_cmp_z(q, z) > 0; }

  static bool eval(mpf_srcptr f, mpf_srcptr g) { return mpf_cmp(f, g) < 0; }

  static bool eval(mpf_srcptr f, unsigned long int l) { return mpf_cmp_ui(f, l) < 0; }
  static bool eval(unsigned long int l, mpf_srcptr f) { return mpf_cmp_ui(f, l) > 0; }
  static bool eval(mpf_srcptr f, signed long int l) { return mpf_cmp_si(f, l) < 0; }
  static bool eval(signed long int l, mpf_srcptr f) { return mpf_cmp_si(f, l) > 0; }
  static bool eval(mpf_srcptr f, double d) { return mpf_cmp_d(f, d) < 0; }
  static bool eval(double d, mpf_srcptr f) { return mpf_cmp_d(f, d) > 0; }
  static bool eval(mpf_srcptr f, mpz_srcptr z) { return mpf_cmp_z(f, z) < 0; }
  static bool eval(mpz_srcptr z, mpf_srcptr f) { return mpf_cmp_z(f, z) > 0; }
  static bool eval(mpf_srcptr f, mpq_srcptr q) { return __gmp_cmp_function::eval(f, q) < 0; }
  static bool eval(mpq_srcptr q, mpf_srcptr f) { return __gmp_cmp_function::eval(q, f) < 0; }
};

struct __gmp_binary_greater {
  template <class T, class U>
  static inline bool eval(T t, U u) {
    return __gmp_binary_less::eval(u, t);
  }
};

struct __gmp_unary_increment {
  static void eval(mpz_ptr z) { mpz_add_ui(z, z, 1); }
  static void eval(mpq_ptr q) { mpz_add(mpq_numref(q), mpq_numref(q), mpq_denref(q)); }
  static void eval(mpf_ptr f) { mpf_add_ui(f, f, 1); }
};

struct __gmp_unary_decrement {
  static void eval(mpz_ptr z) { mpz_sub_ui(z, z, 1); }
  static void eval(mpq_ptr q) { mpz_sub(mpq_numref(q), mpq_numref(q), mpq_denref(q)); }
...
struct __gmp_hypot_function {
  ...
  static void eval(mpf_ptr f, unsigned long int l, mpf_srcptr g) { eval(f, g, l); }
  static void eval(mpf_ptr f, mpf_srcptr g, signed long int l) { eval(f, g, __gmpxx_abs_ui(l)); }
  static void eval(mpf_ptr f, signed long int l, mpf_srcptr g) { eval(f, g, l); }
  static void eval(mpf_ptr f, mpf_srcptr g, double d) {
    mpf_t temp;
    mpf_init2(temp, mpf_get_prec(f));
...
struct __gmp_gcd_function {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_gcd(z, w, v); }
  static void eval(mpz_ptr z, mpz_srcptr w, unsigned long int l) { mpz_gcd_ui(z, w, l); }
  static void eval(mpz_ptr z, unsigned long int l, mpz_srcptr w) { eval(z, w, l); }
  static void eval(mpz_ptr z, mpz_srcptr w, signed long int l) { eval(z, w, __gmpxx_abs_ui(l)); }
  static void eval(mpz_ptr z, signed long int l, mpz_srcptr w) { eval(z, w, l); }
  static void eval(mpz_ptr z, mpz_srcptr w, double d) {
    __GMPXX_TMPZ_D;
    mpz_gcd(z, w, temp);
...
struct __gmp_lcm_function {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_lcm(z, w, v); }
  static void eval(mpz_ptr z, mpz_srcptr w, unsigned long int l) { mpz_lcm_ui(z, w, l); }
  static void eval(mpz_ptr z, unsigned long int l, mpz_srcptr w) { eval(z, w, l); }
  static void eval(mpz_ptr z, mpz_srcptr w, signed long int l) { eval(z, w, __gmpxx_abs_ui(l)); }
  static void eval(mpz_ptr z, signed long int l, mpz_srcptr w) { eval(z, w, l); }
  static void eval(mpz_ptr z, mpz_srcptr w, double d) {
...
struct __gmp_rand_function {
  static void eval(mpz_ptr z, gmp_randstate_t s, mp_bitcnt_t l) { mpz_urandomb(z, s, l); }
  static void eval(mpz_ptr z, gmp_randstate_t s, mpz_srcptr w) { mpz_urandomm(z, s, w); }
  static void eval(mpf_ptr f, gmp_randstate_t s, mp_bitcnt_t prec) { mpf_urandomb(f, s, prec); }
};
...
struct __gmp_fac_function {
  ...
  static void eval(mpz_ptr z, signed long l) {
    if (l < 0) throw std::domain_error("factorial(negative)");
...
struct __gmp_primorial_function {
  ...
  static void eval(mpz_ptr z, signed long l) {
    if (l < 0) throw std::domain_error("primorial(negative)");
    eval(z, static_cast<unsigned long>(l));
  }
  static void eval(mpz_ptr z, mpz_srcptr w) {
    if (!mpz_fits_ulong_p(w)) {
...
struct __gmp_fib_function {
  ...
  static void eval(mpz_ptr z, signed long l) {
    if (l < 0) {
      eval(z, -static_cast<unsigned long>(l));
      if ((l & 1) == 0) mpz_neg(z, z);
    } else
      eval(z, static_cast<unsigned long>(l));
  }
  static void eval(mpz_ptr z, mpz_srcptr w) {
    if (!mpz_fits_slong_p(w)) throw std::bad_alloc();  // or std::overflow_error ("fibonacci")?
    eval(z, mpz_get_si(w));
  }
  static void eval(mpz_ptr z, double d) {
    __GMPXX_TMPZ_D;
...
#define __GMPP_DECLARE_UNARY_STATIC_MEMFUN(T, fun, eval_fun)               \
  template <class U>                                                       \
  static __gmp_expr<T, __gmp_unary_expr<__gmp_expr<T, U>, eval_fun> > fun( \
      const __gmp_expr<T, U>& expr);

#define __GMPNN_DECLARE_UNARY_STATIC_MEMFUN(T, fun, eval_fun, type, bigtype) \
  static inline __gmp_expr<T, __gmp_unary_expr<bigtype, eval_fun> > fun(type expr);
...
class __gmp_expr<mpz_t, mpz_t> {
 ...
 public:
  ...
  __gmp_expr& operator=(const char* s) {
    if (mpz_set_str(mp, s, 0) != 0) throw std::invalid_argument("mpz_set_str");
    return *this;
  }
  __gmp_expr& operator=(const std::string& s) {
    if (mpz_set_str(mp, s.c_str(), 0) != 0) throw std::invalid_argument("mpz_set_str");
    return *this;
  }

  // string input/output functions
  int set_str(const char* s, int base) { return mpz_set_str(mp, s, base); }
  int set_str(const std::string& s, int base) { return mpz_set_str(mp, s.c_str(), base); }
...
class __gmp_expr<mpq_t, mpq_t> {
 ...
 public:
  ...
  __gmp_expr& operator=(const char* s) {
    if (mpq_set_str(mp, s, 0) != 0) throw std::invalid_argument("mpq_set_str");
    return *this;
  }
  __gmp_expr& operator=(const std::string& s) {
    if (mpq_set_str(mp, s.c_str(), 0) != 0) throw std::invalid_argument("mpq_set_str");
    return *this;
  }

  // string input/output functions
  int set_str(const char* s, int base) { return mpq_set_str(mp, s, base); }
  int set_str(const std::string& s, int base) { return mpq_set_str(mp, s.c_str(), base); }
  std::string get_str(int base = 10) const {
  ...
  // exactly an mpz_t
  const mpz_class& get_num() const { return reinterpret_cast<const mpz_class&>(*mpq_numref(mp)); }
  mpz_class& get_num() { return reinterpret_cast<mpz_class&>(*mpq_numref(mp)); }
  const mpz_class& get_den() const { return reinterpret_cast<const mpz_class&>(*mpq_denref(mp)); }
  mpz_class& get_den() { return reinterpret_cast<mpz_class&>(*mpq_denref(mp)); }
...
class __gmp_expr<mpf_t, mpf_t> {
 ...
 public:
  ...
  __gmp_expr& operator=(const char* s) {
    if (mpf_set_str(mp, s, 0) != 0) throw std::invalid_argument("mpf_set_str");
    return *this;
  }
  __gmp_expr& operator=(const std::string& s) {
    if (mpf_set_str(mp, s.c_str(), 0) != 0) throw std::invalid_argument("mpf_set_str");
    return *this;
  }

  // string input/output functions
  int set_str(const char* s, int base) { return mpf_set_str(mp, s, base); }
  int set_str(const std::string& s, int base) { return mpf_set_str(mp, s.c_str(), base); }
...
inline void __gmp_set_expr(mpz_ptr z, const mpz_class& w) { mpz_set(z, w.get_mpz_t()); }
...
inline void __gmp_set_expr(mpq_ptr q, const mpz_class& z) { mpq_set_z(q, z.get_mpz_t()); }
...
inline void __gmp_set_expr(mpq_ptr q, const mpq_class& r) { mpq_set(q, r.get_mpq_t()); }
...
inline void __gmp_set_expr(mpf_ptr f, const mpf_class& g) { mpf_set(f, g.get_mpf_t()); }
...
class __gmp_temp {
 ...
 public:
  ...
  typename __gmp_resolve_expr<T>::srcptr_type __get_mp() const { return val.__get_mp(); }
};
...
class __gmp_expr<T, __gmp_unary_expr<__gmp_expr<T, T>, Op> > {
 ...
 public:
  ...
  void eval(typename __gmp_resolve_expr<T>::ptr_type p) const { Op::eval(p, expr.val.__get_mp()); }
...
class __gmp_expr<T, __gmp_unary_expr<U, Op> > {
 ...
 public:
  explicit __gmp_expr(const val_type& val) : expr(val) {}
  void eval(typename __gmp_resolve_expr<T>::ptr_type p) const { Op::eval(p, expr.val); }
  const val_type& get_val() const { return expr.val; }
  mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }
};
...
#define __GMPZQ_DEFINE_EXPR(eval_fun)                                                          \
  ...
  class __gmp_expr<mpq_t, __gmp_binary_expr<mpq_class, mpz_class, eval_fun> > {                \
   ...
   public:                                                                                     \
    ...
    mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }                            \
                                                                                               ...
                                                                                               \
  template <class T>                                                                           \
  class __gmp_expr<mpq_t, __gmp_binary_expr<mpz_class, __gmp_expr<mpq_t, T>, eval_fun> > {     \
   private:                                                                                    \
    typedef mpz_class val1_type;                                                               \
   ...
   public:                                                                                     \
    ...
    mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }                            \
                                                                                               ...
                                                                                               \
  template <class T>                                                                           \
  class __gmp_expr<mpq_t, __gmp_binary_expr<mpq_class, __gmp_expr<mpz_t, T>, eval_fun> > {     \
   private:                                                                                    \
    typedef mpq_class val1_type;                                                               \
   ...
   public:                                                                                     \
    ...
    mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }                            \
                                                                                               ...
                                                                                               \
  template <class T>                                                                           \
  class __gmp_expr<mpq_t, __gmp_binary_expr<__gmp_expr<mpz_t, T>, mpq_class, eval_fun> > {     \
   private:                                                                                    \
   ...
   public:                                                                                     \
    ...
    mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }                            \
                                                                                               ...
                                                                                               \
  template <class T>                                                                           \
  class __gmp_expr<mpq_t, __gmp_binary_expr<__gmp_expr<mpq_t, T>, mpz_class, eval_fun> > {     \
   private:                                                                                    \
   ...
   public:                                                                                     \
    ...
    mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }                            \
                                                                                               ...
                                                                                               \
  template <class T, class U>                                                                  \
  class __gmp_expr<mpq_t,                                                                      \
                   __gmp_binary_expr<__gmp_expr<mpz_t, T>, __gmp_expr<mpq_t, U>, eval_fun> > { \
   private:                                                                                    \
    typedef __gmp_expr<mpz_t, T> val1_type;                                                    \
  ...
  template <class T, class U>                                                                  \
  class __gmp_expr<mpq_t,                                                                      \
                   __gmp_binary_expr<__gmp_expr<mpq_t, T>, __gmp_expr<mpz_t, U>, eval_fun> > { \
   private:                                                                                    \
    typedef __gmp_expr<mpq_t, T> val1_type;                                                    \
...
#define __GMPP_DEFINE_BINARY_FUNCTION(fun, eval_fun)                                            \
  ...
  fun(const __gmp_expr<T, U>& expr1, const __gmp_expr<V, W>& expr2) {                           \
    return __gmp_expr<typename __gmp_resolve_expr<T, V>::value_type,                            \
                      __gmp_binary_expr<__gmp_expr<T, U>, __gmp_expr<V, W>, eval_fun> >(expr1,  \
                                                                                        expr2); \
  }
...
#define __GMPNN_DEFINE_BINARY_FUNCTION(fun, eval_fun, type, bigtype)                        \
                                                                                            \
  template <class T, class U>                                                               \
  inline __gmp_expr<T, __gmp_binary_expr<__gmp_expr<T, U>, bigtype, eval_fun> > fun(        \
      const __gmp_expr<T, U>& expr, type t) {                                               \
    return __gmp_expr<T, __gmp_binary_expr<__gmp_expr<T, U>, bigtype, eval_fun> >(expr, t); \
  }                                                                                         \
                                                                                            \
  template <class T, class U>                                                               \
  inline __gmp_expr<T, __gmp_binary_expr<bigtype, __gmp_expr<T, U>, eval_fun> > fun(        \
      type t, const __gmp_expr<T, U>& expr) {                                               \
    return __gmp_expr<T, __gmp_binary_expr<bigtype, __gmp_expr<T, U>, eval_fun> >(t, expr); \
  }
...
#define __GMPP_DEFINE_BINARY_FUNCTION_1(T, fun, eval_fun)                                          \
  ...
  inline __gmp_expr<T, __gmp_binary_expr<__gmp_expr<T, U>, __gmp_expr<T, W>, eval_fun> > fun(      \
      const __gmp_expr<T, U>& expr1, const __gmp_expr<T, W>& expr2) {                              \
    return __gmp_expr<T, __gmp_binary_expr<__gmp_expr<T, U>, __gmp_expr<T, W>, eval_fun> >(expr1,  \
                                                                                           expr2); \
  }
...
#define __GMP_DEFINE_BINARY_FUNCTION_UI(fun, eval_fun)                                          \
                                                                                                \
  template <class T, class U>                                                                   \
  inline __gmp_expr<T, __gmp_binary_expr<__gmp_expr<T, U>, mp_bitcnt_t, eval_fun> > fun(        \
      const __gmp_expr<T, U>& expr, mp_bitcnt_t l) {                                            \
    return __gmp_expr<T, __gmp_binary_expr<__gmp_expr<T, U>, mp_bitcnt_t, eval_fun> >(expr, l); \
  }

#define __GMPP_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun)                   \
                                                                                  \
  template <class T, class U, class V, class W>                                   \
  inline type fun(const __gmp_expr<T, U>& expr1, const __gmp_expr<V, W>& expr2) { \
...
#define __GMPNS_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2) \
  __GMPNN_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2, signed long int)

#define __GMPNU_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2) \
  __GMPNN_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2, unsigned long int)
...
#define __GMPP_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun)                                    \
  ...
  inline type##_class& type##_class::fun(const __gmp_expr<T, U>& expr) {                        \
    __gmp_set_expr(                                                                             \
        mp, __gmp_expr<type##_t, __gmp_binary_expr<type##_class, __gmp_expr<T, U>, eval_fun> >( \
                *this, expr));                                                                  \
    return *this;                                                                               \
  }
...
#define __GMPNN_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2, bigtype)                     \
  ...
  inline type##_class& type##_class::fun(type2 t) {                                               \
    __gmp_set_expr(                                                                               \
        mp, __gmp_expr<type##_t, __gmp_binary_expr<type##_class, bigtype, eval_fun> >(*this, t)); \
    return *this;                                                                                 \
  }

#define __GMPNS_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2) \
  __GMPNN_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2, signed long int)

#define __GMPNU_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2) \
  __GMPNN_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2, unsigned long int)
...
#define __GMP_DEFINE_COMPOUND_OPERATOR_UI(type, fun, eval_fun)                                    \
  ...
  inline type##_class& type##_class::fun(mp_bitcnt_t l) {                                         \
    __gmp_set_expr(                                                                               \
        mp,                                                                                       \
        __gmp_expr<type##_t, __gmp_binary_expr<type##_class, mp_bitcnt_t, eval_fun> >(*this, l)); \
    return *this;                                                                                 \
  }
...
#define __GMPP_DEFINE_UNARY_STATIC_MEMFUN(T, fun, eval_fun)                                        \
  template <class U>                                                                               \
  __gmp_expr<T, __gmp_unary_expr<__gmp_expr<T, U>, eval_fun> > fun(const __gmp_expr<T, U>& expr) { \
    return __gmp_expr<T, __gmp_unary_expr<__gmp_expr<T, U>, eval_fun> >(expr);                     \
  }

#define __GMPNN_DEFINE_UNARY_STATIC_MEMFUN(T, fun, eval_fun, type, bigtype)   \
  inline __gmp_expr<T, __gmp_unary_expr<bigtype, eval_fun> > fun(type expr) { \
...
class __gmp_expr<mpz_t, __gmp_urandomm_value> {
 ...
 public:
  ...
  void eval(mpz_ptr z) const { __gmp_rand_function::eval(z, state, range.get_mpz_t()); }
  mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }
};
...
class gmp_randclass {
 ...
 public:
  ...
  gmp_randclass(__gmp_randinit_lc_2exp_t* f, mpz_class z, unsigned long int l1, mp_bitcnt_t l2) {
    f(state, z.get_mpz_t(), l1, l2);
  }

  // gmp_randinit_lc_2exp_size
  gmp_randclass(__gmp_randinit_lc_2exp_size_t* f, mp_bitcnt_t size) {
    if (f(state, size) == 0) throw std::length_error("gmp_randinit_lc_2exp_size");
  }
